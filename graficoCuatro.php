...
$res = mysqli_query($conexion, "SELECT UPPER(nombreCursoSolicitado) As nombreCursoSolicitado, COUNT(nombreCursoSolicitado) As NombreCurso FROM `cursos_solicitados` GROUP BY nombreCursoSolicitado");
