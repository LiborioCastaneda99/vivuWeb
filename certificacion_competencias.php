  ...
  <?php if ($user[9]=='1'): ?>
    ...
    <div class="mt-1 PopUpContainer">
        <div class="contentContainer">
            <ol class="breadcrumb"><li><a href="index.php">Inicio</a></li><li><a class="active" href="certifiacion_competencias.php">Certificación por competencias</a></li></ol>
        </div>
        <!-- ====== PopUpLogin ======-->
                        ...
                        <div class="col-md-8 col-sm-offset-2">
                            <div class="full-width">
                                <form class="simple_form mt-2" id="frmGuardarAprendiz">
                                    ...
                                    <div class="form-group col-md-12">
                                        <button type="button" id="btnGuardarAprendiz" class="btn btn-outline-primary btn-block">Solicitar certificación</button>
                                    </div>
                                    </div>
                                </form>   
