...
if ($Conteo<1) {
	...
	$sql="INSERT INTO cursos (codigo_curso, curso, jornada, horario, intensidad, fecha_inicio, ambiente, formacion, centro, descripcion, nombre_grupo, estado) VALUE('$Codigo','$Curso','$Jornada','$Horario','$Intensidad','$Fecha','$Ambiente','$TipoFormacion','$Centro','$Descripcion','$Grupo','$Estado')";
