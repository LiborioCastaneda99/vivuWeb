...
<head>
  ...
  <title>Editar curso | Oferta Complementaria</title>
    ...
    <!--<div class="contenedor-vistas">-->
      <div class="container down">
        ...
        <div class="container down">
          ...
          <div class="container down">
            <form class="" id="edit_curso_1" action="save-cursos-edit.php" method="post" accept-charset="UTF-8">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group curso_horario">
                      ...
                      <input class="form-control" required="required" aria-required="true" type="text"  name="txtHorario" id="curso_horario" value="<?php echo $data['horario'];?>" />
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group curso_intensidad">
                      ...
                      <input class="form-control" required="required" aria-required="true" type="text"  name="txtIntensidad" id="curso_intensidad" value="<?php echo $data['intensidad'];?>" />
                    </div>
                  </div>
                  <div class="col-md-2">
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group curso_intensidad">
                      ...
                      <input class="form-control" required="required" aria-required="true" type="text"  name="txtMunicipio" id="curso_Municipio" value="<?php echo $data['municipio'];?>" />
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group curso_Direccion">
                      ...
                      <input class="form-control" required="required" aria-required="true" type="text" name="txtDireccion" id="curso_Direccion" value="<?php echo $data['direccion'];?>" />
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group curso_tipo_formacion">
                      ...
                      <input class="form-control" required="required" aria-required="true" type="text"name="txtTipoFormacion" id="curso_tipo_formacion" value="<?php echo $data['formacion'];?>" />
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group curso_tipo_formacion">
