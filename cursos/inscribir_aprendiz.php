...
<meta charset="UFT-8">
  ...
  <title>Inscribir Aprendiz | Oferta Complementaria</title>
...
<?php if(!empty($user)): ?>
  ...
  <?php if ($user[9]=='4'): ?>
    ...
    <div class="mt-4 PopUpContainer">
        ...
        <ol class="breadcrumb"><li><a href="../index.php">Inicio</a></li><li class="active">Inscribir Aprendiz:</li></ol>
        </div>
        <!-- ====== PopUpLogin ======-->
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#cargarCursos').load('tabla_cursos_ofertados.php');
	});
</script>
