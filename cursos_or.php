...
<body> 
  <?php $centro_curso=$user['centro']; if(!empty($user)): ?>
  ...
  <!--<div class="contenedor-vistas">-->
    <div class="container down">
      ...
      <div class="container down">
        <h3 class="text-center text-light">Cursos ofertados</h3>
      ...
      <table class="table table-striped small">
              ...
              <tbody>
               ...
               $sql="SELECT id, codigo_curso, curso, jornada, horario, intensidad, fecha_inicio, municipio, direccion, formacion, centro, descripcion, estado FROM cursos where centro='$centro_curso'";
